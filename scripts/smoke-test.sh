...
container=$(docker run --detach --env-file .env.dist --env POSTGRES_URL="postgres://postgres:password@host.docker.internal:5432" --env REDIS_URI="redis://host.docker.internal:6379" --env HTTP_CACHE_REDIS_URI="redis://host.docker.internal:6379" --add-host="host.docker.internal:host-gateway" "$1")
