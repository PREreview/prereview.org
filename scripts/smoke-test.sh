...
container=$(docker run --detach --env-file .env.dist --env REDIS_URI="redis://host.docker.internal:6379" --env HTTP_CACHE_REDIS_URI="redis://host.docker.internal:6379" --add-host="host.docker.internal:host-gateway" "$1")
