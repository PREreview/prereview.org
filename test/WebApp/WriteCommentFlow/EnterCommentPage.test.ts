...
import * as _ from '../../../src/WebApp/WriteCommentFlow/EnterCommentPage/index.ts'
  ...
  describe('when there is a user', () => {
    describe('when the comment is in progress', () => {
      describe('when there is comment', () => {
        ...
        it.effect.prop(
          "when the comment can't be entered",
          [
            fc.uuid(),
            fc
              .oneof(fc.commentInProgress(), fc.commentReadyForPublishing())
      ...
      it.effect.prop(
        ...
        [
          ...
          fc.oneof(
            ...
            fc
              .anything()
              .filter(body => typeof body === 'object' && (body === null || !Object.hasOwn(body, 'comment'))),
          ),
        ],
