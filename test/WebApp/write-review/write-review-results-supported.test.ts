    ...
    ([preprintId, preprintTitle, [resultsSupported, resultsSupportedDetails, body], user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewResultsSupported({ body, locale, method: 'POST', id: preprintId, user })({ formStore, runtime }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewResultsSupported({ body, locale, method, id: preprintId, user })({ formStore, runtime }),
        )
