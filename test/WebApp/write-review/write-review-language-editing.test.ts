...
describe('writeReviewLanguageEditing', () => {
  it.effect.prop(
    ...
    [
      ...
      fc.preprintTitle(),
      fc.tuple(fc.languageEditing(), fc.languageEditingDetails()).map(([languageEditing, languageEditingDetails]) =>
        Tuple.make(languageEditing, languageEditingDetails, {
          languageEditing,
    ...
    ([preprintId, preprintTitle, [languageEditing, languageEditingDetails, body], user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewLanguageEditing({ body, locale, method: 'POST', id: preprintId, user })({ formStore, runtime }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, user, locale]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewLanguageEditing({ body, locale, method, id: preprintId, user })({
            formStore: new Keyv(),
            runtime,
          }),
        )
  ...
  it.effect.prop(
    ...
    [
      fc.indeterminatePreprintId(),
      fc.preprintTitle(),
      fc.record({ languageEditing: fc.lorem() }, { requiredKeys: [] }),
      fc.user(),
      fc.supportedLocale(),
      fc.questionsForm(),
    ],
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewLanguageEditing({ body, locale, method, id: preprintId, user })({ formStore, runtime }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, locale]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewLanguageEditing({ body, locale, method, id: preprintId, user: undefined })({
            formStore,
            runtime,
          }),
        )
