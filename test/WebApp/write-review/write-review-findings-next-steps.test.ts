...
describe('writeReviewFindingsNextSteps', () => {
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, [findingsNextSteps, findingsNextStepsDetails, body], user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewFindingsNextSteps({ body, locale, method: 'POST', id: preprintId, user })({
            formStore,
            runtime,
          }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, user, locale]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewFindingsNextSteps({ body, locale, method, id: preprintId, user })({
            formStore: new Keyv(),
            runtime,
          }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, user, locale, newReview]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewFindingsNextSteps({ body, locale, method, id: preprintId, user })({ formStore, runtime }),
        )
  ...
  it.effect.prop(
    ...
    ([preprintId, preprintTitle, body, method, locale]) =>
      Effect.gen(function* () {
        ...
        const actual = yield* Effect.promise(
          _.writeReviewFindingsNextSteps({ body, locale, method, id: preprintId, user: undefined })({
            formStore,
            runtime,
          }),
        )
