...
describe('ChooseYourPersonaSubmission', () => {
  describe('when the user is logged in', () => {
    describe('when there is a incomplete request', () => {
      ...
      it.effect.prop(
        ...
        ([preprintId, user, reviewRequest, preprintTitle, body, locale, error]) =>
          Effect.gen(function* () {
      ...
      it.effect.prop(
        ...
        ([preprintId, user, publicPersona, pseudonymPersona, reviewRequest, preprintTitle, body, locale]) =>
          Effect.gen(function* () {
            const actual = yield* _.ChooseYourPersonaSubmission({ body, preprintId })
    ...
    it.effect.prop(
      ...
      ([preprintId, user, preprintTitle, body, locale]) =>
        Effect.gen(function* () {
          const actual = yield* _.ChooseYourPersonaSubmission({ body, preprintId })
  ...
  it.effect.prop(
    'when the preprint cannot be loaded',
    [fc.indeterminatePreprintId(), fc.user(), fc.urlParams(), fc.supportedLocale()],
    ([preprintId, user, body, locale]) =>
      Effect.gen(function* () {
        const actual = yield* _.ChooseYourPersonaSubmission({ body, preprintId })
  ...
  it.effect.prop(
    'when the user is not logged in',
    [fc.indeterminatePreprintId(), fc.urlParams(), fc.supportedLocale()],
    ([preprintId, body, locale]) =>
      Effect.gen(function* () {
        const actual = yield* _.ChooseYourPersonaSubmission({ body, preprintId })
