...
import * as _ from '../../src/WebApp/ResourcesPage.ts'
...
describe('ResourcesPage', () => {
  it.effect.prop('when the page can be loaded', [fc.supportedLocale(), fc.cmsPage()], ([locale, page]) =>
    Effect.gen(function* () {
      ...
      const actual = yield* _.ResourcesPage.pipe(Effect.provide(Layer.mock(CmsContent, { getPage })))
      ...
      expect(getPage).toHaveBeenCalledWith('Resources')
