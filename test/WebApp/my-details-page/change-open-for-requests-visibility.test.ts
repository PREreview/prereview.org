...
describe('changeOpenForRequestsVisibility', () => {
  it.effect.prop(
    ...
    ([body, method, user, locale, visibility]) =>
      Effect.gen(function* () {
        const actual = yield* Effect.promise(
          _.changeOpenForRequestsVisibility({ body, locale, method, user })({
  ...
  it.effect.prop(
    ...
    ([body, method, locale]) =>
      Effect.gen(function* () {
        const actual = yield* Effect.promise(
          _.changeOpenForRequestsVisibility({ body, locale, method, user: undefined })({
