...
import * as _ from '../../../src/WebApp/ReviewADatasetFlow/CheckYourReviewPage/index.ts'
  ...
  describe('when the dataset review is by the user', () => {
    describe('when the dataset review is in progress', () => {
      it.effect.prop(
        ...
        ([datasetReviewId, locale, user, preview, dataset, publicPersona]) =>
          Effect.gen(function* () {
      ...
      it.effect.prop(
        ...
        ([datasetReviewId, locale, user, preview, dataset, pseudonymPersona]) =>
          Effect.gen(function* () {
            const actual = yield* _.CheckYourReviewPage({ datasetReviewId })
      ...
      it.effect.prop(
        ...
        ([datasetReviewId, locale, user, preview, dataset]) =>
          Effect.gen(function* () {
            const actual = yield* _.CheckYourReviewPage({ datasetReviewId })
    ...
    it.effect.prop(
      ...
      ([datasetReviewId, locale, user, preview, dataset, error]) =>
        Effect.gen(function* () {
          const actual = yield* _.CheckYourReviewPage({ datasetReviewId })
    ...
    it.effect.prop(
      ...
      ([datasetReviewId, locale, user, [missing, expected]]) =>
        Effect.gen(function* () {
          const actual = yield* _.CheckYourReviewPage({ datasetReviewId })
...
describe('CheckYourReviewSubmission', () => {
  describe('when the form is submitted', () => {
    ...
    it.effect.prop(
      "when the review can't be published",
      [
        fc.uuid(),
        fc.supportedLocale(),
        fc.user(),
      ...
      ([datasetReviewId, locale, user, error]) =>
        Effect.gen(function* () {
          const actual = yield* _.CheckYourReviewSubmission({ datasetReviewId })
