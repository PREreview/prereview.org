...
import * as _ from '../../../src/WebApp/ReviewADatasetFlow/IsAppropriateForThisKindOfResearchQuestion/index.ts'
import { RouteForCommand } from '../../../src/WebApp/ReviewADatasetFlow/RouteForCommand.ts'
import * as EffectTest from '../../EffectTest.ts'
import * as fc from '../../fc.ts'

describe('IsAppropriateForThisKindOfResearchQuestion', () => {
  describe('when the dataset review is by the user', () => {
    test.prop([
      ...
      Effect.gen(function* () {
        const actual = yield* _.IsAppropriateForThisKindOfResearchQuestion({ datasetReviewId })
        ...
        Effect.provide(
          Layer.mock(DatasetReviews.DatasetReviewQueries, {
            checkIfUserCanAnswerIfTheDatasetIsAppropriateForThisKindOfResearch: () => Effect.succeed(answer),
          }),
        ),
...
describe('IsAppropriateForThisKindOfResearchSubmission', () => {
        ...
        Effect.gen(function* () {
          ...
          Effect.provide(
            Layer.mock(DatasetReviews.DatasetReviewCommands, {
              answerIfTheDatasetIsAppropriateForThisKindOfResearch: () => Effect.void,
            }),
          ),
          Effect.provide(
            Layer.mock(DatasetReviews.DatasetReviewQueries, {
