...
import * as _ from '../../../src/DatasetReviews/Commands/AnswerIfTheDatasetHasDataCensoredOrDeleted.js'
...
const answered1 = new DatasetReviews.AnsweredIfTheDatasetHasDataCensoredOrDeleted({ answer: 'no', datasetReviewId })
const answered2 = new DatasetReviews.AnsweredIfTheDatasetHasDataCensoredOrDeleted({ answer: 'yes', datasetReviewId })
...
describe('decide', () => {
  ...
  test.prop([fc.orcid(), command()])('has not been answered', (authorId, command) => {
    ...
    expect(result).toStrictEqual(
      Either.right(
        Option.some(
          new DatasetReviews.AnsweredIfTheDatasetHasDataCensoredOrDeleted({
