...
describe('authorize', () => {
  ...
  describe('has been answered', () => {
    test.prop([command(), fc.constantFrom('yes', 'no', 'unsure'), fc.maybe(fc.nonEmptyString())])(
      'with the same user',
    ...
    test.prop([command(), fc.orcidId(), fc.constantFrom('yes', 'no', 'unsure'), fc.maybe(fc.nonEmptyString())])(
