...
import * as _ from '../../../src/DatasetReviews/Queries/GetNextExpectedCommandWithoutAuthorInvitesForAUserOnADatasetReview.ts'
...
describe('GetNextExpectedCommandWithoutAuthorInvitesForAUserOnADatasetReview', () => {
  describe('when it has not been started', () => {
    it.prop(
      ...
      ([events]) => {
        const actual = _.GetNextExpectedCommandWithoutAuthorInvitesForAUserOnADatasetReview(events)
