...
import * as _ from '../../../src/DatasetReviews/Queries/CheckIfUserCanAnswerIfTheDatasetIsErrorFree.ts'
...
const answered1 = new DatasetReviews.AnsweredIfTheDatasetIsErrorFree({
  answer: 'no',
  detail: Option.none(),
  datasetReviewId,
})
const answered2 = new DatasetReviews.AnsweredIfTheDatasetIsErrorFree({
  answer: 'yes',
