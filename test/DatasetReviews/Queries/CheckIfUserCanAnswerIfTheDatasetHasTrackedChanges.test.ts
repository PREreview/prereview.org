...
import * as _ from '../../../src/DatasetReviews/Queries/CheckIfUserCanAnswerIfTheDatasetHasTrackedChanges.ts'
...
const answered1 = new DatasetReviews.AnsweredIfTheDatasetHasTrackedChanges({
  answer: 'no',
  detail: Option.none(),
  datasetReviewId,
})
const answered2 = new DatasetReviews.AnsweredIfTheDatasetHasTrackedChanges({
  answer: 'yes',
