...
it.effect.each([
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Kalindu Ramyasoma Hewawasam'), orcid: OrcidId.OrcidId('0000-0002-9796-2294') },
        { name: Name('Akihiko Yamamoto') },
        { name: Name('Maxwell Scott'), orcid: OrcidId.OrcidId('0000-0001-6536-4735') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Nicholas Hum'), orcid: OrcidId.OrcidId('0000-0003-1605-3193') },
        { name: Name('Aimy Sebastian'), orcid: OrcidId.OrcidId('0000-0002-7822-7040') },
        { name: Name('Kelly Martin') },
        { name: Name('Sean Gilmore') },
        { name: Name('Stephen Byers') },
        { name: Name('Elizabeth Wheeler') },
        { name: Name('Matthew Coleman') },
        { name: Name('Gabriela Loots') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [{ name: Name('Shengyang Yu') }, { name: Name('Aaron Tward') }, { name: Name('Sarah Knox') }],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Christopher Cappa'), orcid: OrcidId.OrcidId('0000-0002-3528-3368') },
        { name: Name('Christopher Lim') },
        { name: Name('David Hagan') },
        { name: Name('Jesse Kroll') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Andrew Schwartz'), orcid: OrcidId.OrcidId('0000-0002-2623-5962') },
        { name: Name('Randall Osterhuber') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Racine Rangel'), orcid: OrcidId.OrcidId('0000-0002-2833-0832') },
        { name: Name('Matthew Bracken') },
        { name: Name('Kristy Kroeker') },
        { name: Name('Luke Miller') },
        { name: Name('Cascade Sorte') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [{ name: Name('Alison Rickard'), orcid: OrcidId.OrcidId('0000-0002-7939-8394') }],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Virginia Brancato'), orcid: OrcidId.OrcidId('0000-0001-6322-0439') },
        { name: Name('Eric Rignot') },
        { name: Name('Pietro Milillo') },
        { name: Name('Mathieu Morlighem'), orcid: OrcidId.OrcidId('0000-0001-5219-1310') },
        { name: Name('Jeremie Mouginot') },
        { name: Name('Lu An'), orcid: OrcidId.OrcidId('0000-0003-3507-5953') },
        { name: Name('Bernd Scheuchl') },
        { name: Name('Seong Su Jeong'), orcid: OrcidId.OrcidId('0000-0002-6844-5925') },
        { name: Name('Paola Rizzoli') },
        { name: Name('Jose Luiz Bueso Bello') },
        { name: Name('Pau Prats-Iraola') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Annabel Beichman'), orcid: OrcidId.OrcidId('0000-0002-6991-587X') },
        { name: Name('Jacqueline Robinson') },
        { name: Name('Meixi Lin') },
        { name: Name('Andrés Moreno-Estrada') },
        { name: Name('Sergio Nigenda-Morales') },
        { name: Name('Kelley Harris') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Katherine Dale'), orcid: OrcidId.OrcidId('0000-0002-8544-1571') },
        { name: Name('Elena Pilch') },
        { name: Name('Mary Gomes') },
        { name: Name('Nora Laszlo') },
        { name: Name('Adam Mercer') },
        { name: Name('Rita Mehta') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Dongbo Peng'), orcid: OrcidId.OrcidId('0000-0002-9857-3303') },
        { name: Name('Guoyuan Wu') },
        { name: Name('Kanok Boriboonsomsin') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [{ name: Name('Cynthia Campolina'), orcid: OrcidId.OrcidId('0000-0002-8440-2458') }],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Rondineli Mendes da Silva'), orcid: OrcidId.OrcidId('0000-0002-6243-5179') },
        { name: Name('Sarah Gomes Pitta Lopes') },
        { name: Name('Vera Lúcia Luiza'), orcid: OrcidId.OrcidId('0000-0001-6245-7522') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Daniel Rodríguez'), orcid: OrcidId.OrcidId('0000-0003-2370-6543') },
        { name: Name('Lisette Fuentes-Ugarte'), orcid: OrcidId.OrcidId('0000-0002-7555-3019') },
        { name: Name('Leonardo Cuevas-Zepeda'), orcid: OrcidId.OrcidId('0000-0002-1310-1850') },
        { name: Name('Karina Hunter-Echeverría'), orcid: OrcidId.OrcidId('0000-0003-0681-6257') },
        { name: Name('Noelia Figueroa Burdiles'), orcid: OrcidId.OrcidId('0000-0001-7874-004X') },
      ],
  ...
  },
  {
    ...
    expected: new Datasets.Dataset({
      ...
      authors: [
        { name: Name('Joshphar Kunapo'), orcid: OrcidId.OrcidId('0000-0002-0514-4658') },
        { name: Name('Kathryn Russell'), orcid: OrcidId.OrcidId('0000-0002-9613-4665') },
      ],
