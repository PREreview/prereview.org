...
describe('getPrereviewFromZenodo', () => {
  ...
  test.prop([fc.integer(), fc.preprintDoi(), fc.constantFrom(new PreprintIsNotFound(), new PreprintIsUnavailable())])(
...
describe('getPrereviewsForUserFromZenodo', () => {
  ...
  test.prop([fc.user(), fc.preprintTitle(), fc.constantFrom(new PreprintIsNotFound(), new PreprintIsUnavailable())])(
...
describe('getPrereviewsForClubFromZenodo', () => {
  ...
  test.prop([fc.clubId(), fc.preprintTitle(), fc.constantFrom(new PreprintIsNotFound(), new PreprintIsUnavailable())])(
    'when a preprint cannot be loaded',
  ...
  test.prop([fc.doi()])('when the comments can be loaded', async id => {
    ...
    expect(actual).toStrictEqual(
      E.right([
        ...
        {
          authors: { named: [{ name: 'Josiah Carberry' }] },
          doi: '10.5281/zenodo.1065236',
          id: 1065236,
          language: 'en',
          license: 'CC-BY-4.0',
          published: new Temporal.PlainDate(2022, 7, 5),
          text: rawHtml('Some other text'),
        },
      ]),
    )
  })
