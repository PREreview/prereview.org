...
import * as _ from '../../../src/ExternalApis/Datacite/Record.js'
...
describe('getRecord', () => {
  test.prop(
    ...
    {
      examples: [
        [[Doi('10.17605/OSF.IO/EQ8BK'), 'https://api.datacite.org/dois/10.17605%2FOSF.IO%2FEQ8BK']],
        [
          [
  ...
  )('calls the records API', ([doi, expectedUrl]) =>
    Effect.gen(function* () {
