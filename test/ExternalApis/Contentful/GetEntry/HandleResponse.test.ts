...
import * as _ from '../../../../src/ExternalApis/Contentful/GetEntry/HandleResponse.ts'
      ...
      it.effect.prop(
        ...
        [
          fc.httpClientResponse({
            body: fc.fileInDirectory('test/ExternalApis/Contentful/GetEntry/Samples'),
    ...
    it.effect.prop(
      ...
      ([response]) =>
        Effect.gen(function* () {
          ...
          expect(actual._tag).toStrictEqual('EntryIsNotFound')
