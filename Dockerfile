FROM node:24.0.1-bookworm-slim AS node
...
#
FROM --platform=linux/amd64 debian:12.10-slim AS intlc
ENV LANG=C.UTF-8
ENV LC_ALL=C.UTF-8
WORKDIR /app
...
#
FROM mcr.microsoft.com/playwright:v1.51.1-jammy AS test-integration
WORKDIR /app
