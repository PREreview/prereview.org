FROM node:25.0.0-bookworm-slim AS node
...
#
FROM --platform=linux/amd64 debian:13.1-slim AS intlc
ENV LANG=C.UTF-8
ENV LC_ALL=C.UTF-8
WORKDIR /app
...
#
FROM mcr.microsoft.com/playwright:v1.56.0-jammy AS test-integration
WORKDIR /app
