...
export const DefaultClubs: Array.NonEmptyReadonlyArray<ClubDetails> = [
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The African Women in STEM Peer Review Hub is a community-driven initiative dedicated to supporting,
          connecting, and empowering African women in science, technology, engineering, and mathematics. It aims to
          promote equitable participation, professional development, knowledge exchange, and greater visibility of
          African women in the global research community.
        </p>
        <p>
          The African Women in STEM Peer Review Hub is a collaborative community that empowers African women researchers
          to develop peer-review expertise, critically engage with emerging research, and contribute meaningfully to the
          scholarly publishing ecosystem. Through collaborative peer review, mentorship, knowledge exchange, and
          capacity building, the Club aims to foster a culture of constructive and inclusive peer review while
          strengthening the visibility, confidence, and leadership of African women in research.
        </p>
      `,
    },
    ...
    joinLink: new URL(
      'https://docs.google.com/forms/d/e/1FAIpQLSf3C65-nJ3tNghPA5Sf0BY7Qc99H8eYNT1lUYJTn4zoY5pFTw/viewform?usp=header',
    ),
  },
  {
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          We are a young lab part of BIMSB (Berlin Institute for Medical Systems Biology) located in Berlin (Germany).
          We seek to understand how intrinsically disordered proteins (dys)regulate brain metabolism using advanced
          imaging techniques.
        </p>
        <p>
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          We are a community of biology education students, researchers, and educators who collaboratively review
          emerging bio-ed preprints.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          One of the community's aspects is promoting objective and non-anonymous peer review, which enriches the work
          of scientists who publish preprints.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          We aim to foster an environment of continuous learning and knowledge-sharing. To this end, we have initiated
          the PrePrint Review Club. The purpose of this club is to encourage the practice of reading, reviewing, and
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          We are a team of scientists with a broad range of expertise encompassing structural biology, biochemistry,
          plant biology and cell biology. We are affiliated with the
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          ...
          scientific discussions on biodiversity sciences, ecology and biological conservation with respect and
          fairness. We embrace open science values, and so our reviews always consider reproducibility, replicability,
          FAIR and CARE principles, and EDIA in scientific products.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The Biophysics Institute (3. Institute of Physics) at the University of Göttingen has a strong focus on
          imaging, cell mechanics and robotics. Besides doing research, we love to read and discuss science.
        </p>
        <p>
          This Club is the PREreview manifestation of a seminar CARA that Timo teaches every semester at the University
          of Göttingen. We discuss each week two papers on subjects around biophysics with a focus on cell mechanics. To
          gain credits, students need to prepare a peer review of the paper they present, and this club allows them to
          publish this review, thus hopefully helping the authors to improve their preprints.
        </p>
      `,
    },
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          ...
          submission. Looking ahead, we see review of preprints by researchers outside of EMERGE as an avenue for
          further internationalizing the project.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The PREreview Club at Future of Research Communication and e-Scholarship (<a href="https://force11.org/"
            >FORCE11</a
          >) publishes reviews of preprints in metascience, metaresearch, scholarly communication, and related fields.
        </p>
        <p>
        ...
        <p>Our club meets at 5PM UTC on each Wednesday of the third full week of the month in odd numbered months.</p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          <a href="https://jmirpublications.com/">JMIR Publications</a> teamed up with PREreview to expand our
          innovative peer review offerings through
          <a href="https://support.jmir.org/hc/en-us/articles/4408266275099">Live Reviews</a>: topic-centered,
          interactive preprint review calls via a video conference tool such as Zoom.
        </p>
        <p>
        ...
        <p>
          ...
          JMIRx journal or another <a href="https://planp.science/">Plan P</a>–compatible journal. To learn more about
          the JMIRx project, see our help article
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          The NSA PREreview club is the hub of NSA’s journal club activities. NSA members may meet in groups to discuss
          a paper and write a PREreview as a group or do the whole process individually.
        </p>
      `,
    },
    added: Temporal.PlainDate.from('2024-02-09'),
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          <a href="https://openboxscience.org/">Open Box Science (OBS)</a> is a 501(c)(3) nonprofit organization
          dedicated to promoting open science and democratizing scientific training. The OBS grassroots community
          organizes free talks by early-career scientists and is open to all around the world.
        </p>
        <p>
          The OBS PREreview club will provide reviews of selected preprints presented in OBS seminars. The purpose of
          the club is to (i) provide continuous discussion and collaboration to help advance science, and to (ii)
          provide an open platform for training and practice in responsible peer review.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          Open Science Community Iraqi (OSCI) describes an ongoing movement in the way research is performed,
          researchers collaborate, knowledge is shared, and science is organized. It affects the whole research cycle
          and its stakeholders and enhances science by facilitating more transparency, openness, networking, and
          collaboration.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          The Open Scholarship Initiative at SFU aims at promoting people-first open scholarship principles and
          practices. This club will provide infrastructure to make one of these practices visible and recognized, by
          compiling a record of all the preprint reviews published by our community. You must be affiliated with SFU to
          join the club, but collaborations are welcome.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The Department of Biology at the University of Oxford conducts pioneering research across all areas of
          biology, driving discoveries that address global scientific challenges.
        </p>
        <p>
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The Graduate School in Biomedical Sciences at the University of Padua offers cutting-edge training and
          research opportunities across a broad spectrum of biomedical disciplines. The School trains early-career
          researcher in molecular, cellular, and clinical sciences, fostering international collaboration and open
          science. Its mission is to prepare the next generation of scientists.
        </p>
        <p>
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The club will primarily deal with preprints with major focus on various kinds of parasites (whether it's
          macro- or micro-; ecto- or endo-, etc.) , their morphology, life cycle, mode of parasitism and host-parasite
          ...
          hosts. Those preprints highlighting preventive measures, prognoses and/or diagnoses, prophylaxis, clinical
          signs and symptoms, and novel/existing treatment of diseases will also be considered for revision.
        </p>
        <p>
    ...
    description: {
      ...
      text: html`
        <p>
          ...
          Physical Education at the <a href="https://www.uem.br">State University of Maringá</a> (Brazil) and is
          connected to initiatives promoted by the
          ...
          journal’s editorial commitment to transparency, collaboration, and the recognition of diverse forms of
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          We are a group of scientists at the University of Yaounde 1 / Faculty of Science / Department of Plant
          Biology.
        </p>
    ...
    description: {
      ...
      text: html`
        <p>
          ...
          exclusively) on the signalling pathways sustaining proteostasis in the Endoplasmic Reticulum (ER), the
          clinical relevance of such mechanisms, and the potential of their therapeutic targeting in solid tumours
          (mainly brain and breast cancers).
        </p>
        <p>
  ...
  },
  {
    ...
    description: {
      language: 'en',
      text: html`
        <p>The network started as a club with support from the ASAPbio community seed grant (850 USD) project to help promote open science and access in Rwanda. However, due to the burning interest in becoming inclusive and meeting the needs of a wider scientific community in Africa regarding open science and access, we changed the club’s aims and scope. Today, the network, which was initially called the “Rwanda Preprint Club,” is the “Review and Curate Network (RCN).</p>

<p>The network aims to foster a collaborative and transparent environment for the evaluation, validation, and organization of preprints. By focusing on preprints, the club also aims to accelerate scientific progress, allowing for immediate dissemination of findings while maintaining the rigor of traditional Science.</p>

<p>The club reviews English and French-language preprints, produces podcasts on Open Science, conducts evidence syntheses on Open Science topics and other types of research activities, and has piloting collaborative review processes among undergraduate students to assess how best they could get involved in live peer reviews.</p>

<p>RCN is led by Dine Roseline Dzekem (Founder and Executive Director), Ogunniyi Tolulope Joseph (Production Manager), and Shitondo Yahila (Program Manager).</p>
    `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          It also exists to help the authors of the stomatology union in improving the writing and publication of
          articles related to this science.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The SFB1638 is a research consortium that is interested in understanding the dynamics of cellular membranes
          and how membrane remodeling events are coupled to generate physiological processes.
        </p>
        <p>
          This preprint review club brings together early career researchers of the SFB1638 to discuss the latest
          research in the field and develop their ability to constructively review research data.
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The Society for the Neurobiology of Language (SNL) is a non-profit organization whose goal is to foster
          progress in understanding the neurobiological basis for language via the interdisciplinary exchange of ideas.
          The Society brings together scientists with different perspectives and methodological approaches to the study
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          The Bioinformatics Journal club intends to provide a platform for the students and different research groups
          in the faculty to present projects, discuss publications and
        </p>
      `,
    },
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        ...
        <p>
          This club will review preprints related to multilingual open science, exploring that idea broadly. We don’t
          plan to have a fixed schedule–we’ll take opportunities to review compelling preprints as they arise.
        </p>
      `,
    },
    added: Temporal.PlainDate.from('2026-02-24'),
  ...
  },
  {
    ...
    description: {
      ...
      text: html`
        <p>
          The Sainsbury Laboratory is an independent research institute renowned for world-leading fundamental
          discoveries in molecular plant-microbe interactions.
        </p>
    ...
    description: {
      ...
      text: html`
        <p>
          ...
          survival of plants as complex, multicellular organisms. Particular emphasis is placed on plant development,
          the interaction between plants and microbes, and plant responses and adaptations to changing environmental
          conditions.
        </p>
        <p>
