...
import * as DeclareCompetingInterestsForm from './DeclareCompetingInterestsForm.ts'
import { DeclareCompetingInterestsPage as MakeResponse } from './DeclareCompetingInterestsPage.ts'
