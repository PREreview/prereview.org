      ...
      CompletedForm: Effect.fn(
        function* (form: IsAppropriateForThisKindOfResearchForm.CompletedForm) {
          yield* DatasetReviews.answerIfTheDatasetIsAppropriateForThisKindOfResearch({
            ...
            detail: pipe(
              Match.value(form.isAppropriateForThisKindOfResearch),
              Match.when('yes', () => form.isAppropriateForThisKindOfResearchYesDetail),
              Match.when('partly', () => form.isAppropriateForThisKindOfResearchPartlyDetail),
              Match.when('no', () => form.isAppropriateForThisKindOfResearchNoDetail),
