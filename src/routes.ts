...
export const RequestAReviewNeedToVerifyEmailAddress = Route({
  path: '/preprints/:preprintId/request-a-prereview/need-to-verify-email-address',
  href: params =>
    `/preprints/${Schema.encodeSync(PreprintIdSchema)(params.preprintId)}/request-a-prereview/need-to-verify-email-address`,
  schema: Schema.Struct({ preprintId: PreprintIdSchema }),
})

export const RequestAReviewReceiveNotifications = Route({
  path: '/preprints/:preprintId/request-a-prereview/receive-notifications',
  href: params =>
    `/preprints/${Schema.encodeSync(PreprintIdSchema)(params.preprintId)}/request-a-prereview/receive-notifications`,
  schema: Schema.Struct({ preprintId: PreprintIdSchema }),
})
...
export const RequestAReviewCheckYourRequest = Route({
  ...
  href: params =>
    `/preprints/${Schema.encodeSync(PreprintIdSchema)(params.preprintId)}/request-a-prereview/check-your-request`,
  schema: Schema.Struct({ preprintId: PreprintIdSchema }),
})
...
export const ReviewADatasetOthersNeedToBeListedOnTheReview = Route({
  path: '/review-a-dataset/:datasetReviewId/others-need-to-be-listed',
  href: params => `/review-a-dataset/${params.datasetReviewId}/others-need-to-be-listed`,
  schema: Schema.Struct({ datasetReviewId: Uuid.UuidSchema }),
})
...
export const ReviewADatasetRemoveInvitationToAppear = Route({
  path: '/review-a-dataset/:datasetReviewId/remove-author/:invitationId',
  href: params => `/review-a-dataset/${params.datasetReviewId}/remove-author/${params.invitationId}`,
  schema: Schema.Struct({ datasetReviewId: Uuid.UuidSchema, invitationId: Uuid.UuidSchema }),
})

export const ReviewADatasetCheckInvitationsToAppear = Route({
  path: '/review-a-dataset/:datasetReviewId/add-more-authors',
  href: params => `/review-a-dataset/${params.datasetReviewId}/add-more-authors`,
  schema: Schema.Struct({ datasetReviewId: Uuid.UuidSchema }),
})
...
export const AuthorInviteAcceptInvite = Route({
  path: '/dataset-review-author-invite/:invitationId/accept-invite',
  href: params => `/dataset-review-author-invite/${params.invitationId}/accept-invite`,
  schema: Schema.Struct({ invitationId: Uuid.UuidSchema }),
})
