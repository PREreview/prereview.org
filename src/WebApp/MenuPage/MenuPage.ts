      ...
      <div class="menu">
        <div>
          ...
          <ul>
            ...
            <li>
              <a href="${Routes.ReviewRequests.href({ page: 1 })}">${t('menuRequests')()}</a>
            ...
            <li>
              <a href="${Routes.ChampionsProgram}">${t('menuChampions')()}</a>
              <p>${t('menuChampionsHint')()}</p>
            </li>
          </ul>
        </div>
        ...
        <div>
          ...
          <ul>
            ...
            <li>
              <a href="https://stats.prereview.org/">${t('menuStatistics')()}</a>
            </li>
          </ul>
        </div>
          ...
          <ul>
            ${Boolean.match(isLoggedIn, {
              onTrue: () => html`
                ...
                <li>
                  <a href="${Routes.MyReviewRequests}">${t('menuMyReviewRequests')()}</a>
                </li>
                <li>
