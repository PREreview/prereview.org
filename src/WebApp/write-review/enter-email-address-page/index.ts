import { Effect, Match, Option, String, Struct, flow, pipe } from 'effect'
...
import { ContactEmailAddresses, type UnverifiedContactEmailAddress } from '../../../ContactEmailAddresses/index.ts'
...
const handleEnterEmailAddressForm = ({
  ...
  pipe(
    ...
    RTE.matchEW(
      form => RT.of(enterEmailAddressPage(preprint, form, locale)),
