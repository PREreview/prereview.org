...
const DoiD = pipe(
  ...
  D.refine(hasRegistrant('1101', '1590', '21203', '31219', '31234', '31235', '31730'), 'DOI'),
)
        ...
        <form method="post" action="${format(homeMatch.formatter, {})}" novalidate>
          <div ${rawHtml(E.isLeft(lookupDoi) ? 'class="error"' : '')}>
            ...
            <div id="doi-tip" role="note">
              We support AfricArXiv, bioRxiv, medRxiv, OSF, PsyArXiv, Research Square, SciELO and SocArXiv preprints.
            </div>
          </div>
