...
const showFindingsNextStepsForm = ({
  ...
  pipe(
    ...
    RM.apS('response', RM.of(findingsNextStepsForm(preprint, FormToFieldsE.encode(form), locale))),
    RM.ichainW(handlePageResponse),
  )

const showFindingsNextStepsErrorForm = ({
  form,
  preprint,
  user,
  locale,
  ...
  pipe(
    ...
    RM.apS('user', RM.of(user)),
    RM.apS('locale', RM.of(locale)),
    RM.apS('response', RM.of(findingsNextStepsForm(preprint, form, locale))),
    RM.ichainW(handlePageResponse),
  )
  ...
  pipe(
    ...
    RM.orElseW(error =>
      match(error)
        ...
        .with({ findingsNextSteps: P.any }, form => showFindingsNextStepsErrorForm({ form, preprint, user, locale }))
        .exhaustive(),
    ),
  )
