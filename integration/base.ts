  ...
  fetch: async ({}, use) => {
    ...
    fetch.get('https://api.openalex.org/works/https://doi.org/10.1101/2023.02.28.529746', {
      body: {
        ...
        corresponding_author_ids: ['https://openalex.org/A5064536779', 'https://openalex.org/A5074305095'],
        corresponding_institution_ids: [
          'https://openalex.org/I2799548008',
        ...
        fulltext_origin: 'pdf',
        cited_by_count: 3,
        cited_by_percentile_year: { min: 92, max: 94 },
        biblio: { volume: null, issue: null, first_page: null, last_page: null },
        is_retracted: false,
        is_paratext: false,
        primary_topic: {
          id: 'https://openalex.org/T12104',
          display_name: 'Protein Tyrosine Phosphatases in Human Health and Disease',
          score: 1.0,
          subfield: { id: 'https://openalex.org/subfields/1312', display_name: 'Molecular Biology' },
          field: {
            id: 'https://openalex.org/fields/13',
        ...
        topics: [
          ...
          },
          {
            ...
            display_name: 'ATP Synthase Function and Regulation',
            score: 0.997,
            subfield: { id: 'https://openalex.org/subfields/1312', display_name: 'Molecular Biology' },
            field: {
              id: 'https://openalex.org/fields/13',
        ...
        keywords: [
          {
            id: 'https://openalex.org/keywords/atp-synthase',
            display_name: 'ATP Synthase',
            score: 0.490192,
          },
        ],
        mesh: [],
        ...
        locations: [
          ...
          },
          {
            is_oa: true,
            landing_page_url:
              'https://figshare.com/articles/journal_contribution/A_Conserved_Local_Structural_Motif_Controls_the_Kinetics_of_PTP1B_Catalysis/23593031',
            pdf_url:
              'https://figshare.com/articles/journal_contribution/A_Conserved_Local_Structural_Motif_Controls_the_Kinetics_of_PTP1B_Catalysis/23593031/1/files/41389979.pdf',
            source: {
              ...
              is_oa: true,
              is_in_doaj: false,
              host_organization: 'https://openalex.org/I196829312',
              host_organization_name: 'La Trobe University',
              host_organization_lineage: ['https://openalex.org/I196829312'],
              host_organization_lineage_names: ['La Trobe University'],
              type: 'repository',
            },
            license: 'cc-by-nc',
            license_id: 'https://openalex.org/licenses/cc-by-nc',
        ...
        ngrams_url: 'https://api.openalex.org/works/W4323049128/ngrams',
        cited_by_api_url: 'https://api.openalex.org/works?filter=cites:W4323049128',
        counts_by_year: [
          { year: 2024, cited_by_count: 1 },
          { year: 2023, cited_by_count: 2 },
        ],
        updated_date: '2024-05-11T02:00:42.872413',
